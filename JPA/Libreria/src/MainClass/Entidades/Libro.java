...
public class Libro implements Serializable {
    ...
    public String toString() {
        return "Libro{" + "isbn=" + isbn + ", titulo=" + titulo + ", anio=" + anio + ", ejemplares=" + ejemplares + ", ejemplaresPrestados=" + ejemplaresPrestados + ", ejemplaresRestante=" + ejemplaresRestante + ", alta=" + alta + ", autor=" + autor + ", editorial=" + editorial + '}';
    }
